            ...
            >
              <div className="content-two-left-side">
                ...
                <p style={{ marginBottom: "25px" }}>
                  Where classic techniques meet modern style. Discover a
                  grooming experience designed for your unique look and comfort.
                </p>
                <button
            ...
            >
              ...
              <div className="content-two-left-side">
                ...
                <p style={{ marginTop: "25px" }}>
                  ...
                  revitalized and refreshed. Experience unparalleled comfort and
                  a polished finish that boosts your confidence.
                </p>
                <button
                  className="about-us-btn"
                  style={{
